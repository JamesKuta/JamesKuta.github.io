...
var divContainerFullTranscript = document.getElementById(
  "divContainerFullTranscript"
);
var divContainerPartialTranscript = document.getElementById(
  "divContainerPartialTranscript"
);
...
var inputHiddenHamburgerMenu = document.getElementById(
  "inputHiddenHamburgerMenu"
);
...
var inputLeftRightMarginSize = document.getElementById(
  "inputLeftRightMarginSize"
);
...
var divChatContactListContainer = document.getElementById(
  "divChatContactListContainer"
);
var divChatConversationContainer = document.getElementById(
  "divChatConversationContainer"
);
var divChatContactListInner = document.getElementById(
  "divChatContactListInner"
);
var divChatConversationHistory = document.getElementById(
  "divChatConversationHistory"
);
var divChatConversationCurrent = document.getElementById(
  "divChatConversationCurrent"
);
...
pickers.backgroundColor = new ColorPicker(
...
pickers.fontColor = new ColorPicker(
  colorPickerFont,
  changeFontColor,
...
pickers.outlineColor = new ColorPicker(
  colorPickerOutline,
  changeOutlineColor,
...
window.onload = function ()
{
  ...
  registerLongClick(
    document.getElementById("buttonMinusFontSize"),
    decrementFontSize
  );
  registerLongClick(
    document.getElementById("buttonPlusFontSize"),
    incrementFontSize
  );
  registerLongClick(
    document.getElementById("buttonMinusOutlineSize"),
    decrementOutlineSize
  );
  registerLongClick(
    document.getElementById("buttonPlusOutlineSize"),
    incrementOutlineSize
  );
  registerLongClick(
    document.getElementById("buttonMinusLineSpacing"),
    decrementLineSpacing
  );
  registerLongClick(
    document.getElementById("buttonPlusLineSpacing"),
    incrementLineSpacing
  );
  registerLongClick(
    document.getElementById("buttonMinusLeftRightMarginSize"),
    decrementLeftRightMarginSize
  );
  registerLongClick(
    document.getElementById("buttonPlusLeftRightMarginSize"),
    incrementLeftRightMarginSize
  );
  registerLongClick(
    document.getElementById("buttonMinusBottomMarginSize"),
    decrementBottomMarginSize
  );
  registerLongClick(
    document.getElementById("buttonPlusBottomMarginSize"),
    incrementBottomMarginSize
  );
...
function calculateParagraphSizesAsync()
{
  ...
  caseViewNet.LogMessage +=
    "calculateParagraphSizesAsync() " + paragraphSizeArrayIndex + "\r\n";

  var start = new Date();
  do
  {
    var increment =
      paragraphSizeArrayIndex + 100 <= mainBufferCART.length
        ? 100
        : mainBufferCART.length - paragraphSizeArrayIndex;
    ...
    paragraphSizeArrayIndex < mainBufferCART.length &&
    new Date() - start < 50
  );
...
function measureParagraphHeights(from, to)
{
  ...
  caseViewNet.LogMessage += new Date() + "\r\n";
  caseViewNet.LogMessage +=
    "measureParagraphHeights() from " + from + " to " + to + "\r\n";
...
document.body.onkeyup = function (e)
{
  if (
    ...
    !searchFormShowed &&
    viewMode == "TRANSCRIPT" &&
    caseViewNet.mainBuffer.length > 0
  )
  {
...
document.onmousemove = function (event)
{
  ...
  {
    // if mouse goes close to top of screen then show menu
    if (menuShowed)
    {
      if (showMenuTimer)
      {
...
function showHideTopMenu()
{
  ...
  var optionsMenu = { direction: "up" };
  var optionsButton = { direction: "left" };
...
function recalculate(didFollow)
{
  ...
  if (viewMode == "TRANSCRIPT" && lineIndexTop > -1)
  {
    //if we can let's measure exactly the size
    ...
    if (caseViewNet.mainBuffer[lineIndexTop].data.trim().length == 0)
    {
      ...
      {
        if (
          caseViewNet.mainBuffer[i].data.trim().length > 0 &&
          renderedBuffer[i].clientHeight > 0
        )
        {
  ...
  switch (viewMode)
  {
    case "CART":
      ...
      break;
    case "TRANSCRIPT":
      heightFullTranscript =
        caseViewNet.mainBuffer.length * lineHeight +
...
function createInitialPageCART()
{
  ...
  try
  {
    ...
    heightFullCart =
      divCartParagraphList.clientHeight + (topMarginSize + bottomMarginSize);
    divCartParagraphFull.style.height = heightFullCart + "px";
...
function createNewLineTranscript(index, json)
{
  ...
  if (showTimestamps)
  {
    ...
    } else
    {
      div1.setAttribute(
        "class",
        "div-float-left div-timestamp div_right_margin25"
      );
    }
  ...
  if (showLineNumbers)
  {
    ...
    div2.setAttribute(
      "class",
      "div-float-left div-line-number div_right_margin25"
    );
  ...
  if (json.paragraph)
  {
    ...
    while (
      json.data &&
      json.data.length > num &&
      json.data.charAt(num) == " "
    )
    {
      ++num;
    }
...
function adjustContentCART(changeFollow)
{
  ...
  var endOfDocument =
    divCartParagraphFull.clientHeight - divCartInner.scrollTop - windowHeight <
  ...
  if (documentHeightCalculated && lineIndexTop >= 0 && lineIndexBottom >= 0)
  {
    ...
    var newLineIndexBottom = Math.min(
      midIndex + maxlinesAllowed,
      bufferSizeCART - 1
    );

    if (
      newLineIndexTop > lineIndexBottom ||
      newLineIndexBottom < lineIndexTop
    )
    {
      removeLinesCART();
...
function calculateMidIndexCART(scrollTop)
{
  ...
  var offsetScroll = Math.ceil(
    heightFullCart - (scrollTop + windowHeight / 2 - bottomMarginSize)
  );
  var bufferSizeCART = mainBufferCART.length;
  ...
  if (index < 0) index = 0;
  if (index > bufferSizeCART - 1) index = bufferSizeCART - 1;
  return index;
}
...
function adjustContentTranscript()
{
  ...
  var endOfDocument =
    divContainerFullTranscript.clientHeight -
    divContainerScroll.scrollTop -
    windowHeight <
    bottomMarginSize + lineHeight;
  ...
  if (lineIndexTop >= 0 && lineIndexBottom >= 0)
  {
    ...
    } else
    {
      ...
      {
        lineIndexTop--;
        addLineHeadTranscript(
          lineIndexTop,
          caseViewNet.mainBuffer[lineIndexTop]
        );
      }
      ...
      {
        lineIndexBottom++;
        addLineTaleTranscript(
          lineIndexBottom,
          caseViewNet.mainBuffer[lineIndexBottom]
        );
      }
    }
...
function calculateMidIndexTranscript(scrollTop)
{
  ...
  var index =
    Math.ceil((scrollTop + windowHeight / 2 - bottomMarginSize) / lineHeight) -
    1;
...
function switchView()
{
  ...
  if (needToSwitchFontBold) labelFontBold.click();
}
...
function switchUIComponents()
{
  ...
  switch (viewMode)
  {
    case "CART":
      ...
      if (fullscreenEnabled) makeFullscreen(body);
      ...
      break;
    case "TRANSCRIPT":
      if (fullscreenEnabled) cancelFullscreen();
      divContent.removeChild(divCartOutter);
...
function OnInsertLine(index)
{
  ...
  switch (viewMode)
  {
    case "CART":
      ...
      var cartIndex = isNextNewLine
        ? reverseLookupMap[index - 1]
        : reverseLookupMap[index];
    ...
    case "CART":
      ...
      if (indexValues.length == 1)
      {
        if (cartIndex < lineIndexTop)
        {
          lineIndexTop--;
          lineIndexBottom--;
        } else if (cartIndex >= lineIndexTop && cartIndex <= lineIndexBottom)
        {
          //we will remove paragraph from UI
...
function renderUpdateCart(index, renumbered)
{
  ...
  var secondCartIndex = isLastLineDeleted
    ? reverseLookupMap[index - 1]
    : reverseLookupMap[index];
  var firstCartIndex = secondCartIndex;
  if (firstCartIndex > 0 && !isLastLineDeleted) firstCartIndex--;
    ...
    if (start < caseViewNet.mainBuffer.length)
    {
        ...
        if (line.paragraph)
        {
          if (values.length > 0)
          {
            ...
            if (createdParagraphs > availableParagraphs)
            {
              ...
              for (
                var i = values[values.length - 1];
                i < reverseLookupMap.length;
                ++i
              )
              {
                reverseLookupMap[i]++;
      ...
      if (values.length > 0)
      {
        ...
        if (createdParagraphs > availableParagraphs)
        {
          ...
          //needs to increment reverseLookupMap for all following paragraphs
          for (
            var i = values[values.length - 1] + 1;
            i < reverseLookupMap.length;
            ++i
          )
          {
...
function changeBackgroundColor()
{
  ...
  switch (viewMode)
  {
    case "TRANSCRIPT":
      setCookie(
        backgroundColorTranscriptCookie,
        pickers.backgroundColor.getHexString()
      );
      break;
    case "CART":
      setCookie(
        backgroundColorCartCookie,
        pickers.backgroundColor.getHexString()
      );
      break;
  }
...
function changeOutlineColor()
{
  ...
  switch (viewMode)
  {
    case "TRANSCRIPT":
      setCookie(
        outlineColorTranscriptCookie,
        pickers.outlineColor.getHexString()
      );
      break;
    case "CART":
...
function updateStyle(resized)
{
  ...
  {
    attribute =
      "-webkit-text-stroke: " + outlineSize + "px " + colorOutline + "; ";
  ...
  var textHighlightColor = pickers.backgroundColor.isComplimentColorLight()
    ? "#000"
    : "#FFF";
  var textBackgroundColor = pickers.backgroundColor.isLight() ? "#000" : "#FFF";

  var cssText =
    "div.div-data::selection {background: " +
    complimentColor +
    ";\r\n" +
    "color: " +
    textHighlightColor +
    "; } \r\n" +
    "div.div-data::-moz-selection {background: " +
    complimentColor +
    ";\r\n" +
    "color: " +
    textHighlightColor +
    "; } \r\n" +
    "div.div-timestamp {color: " +
    textBackgroundColor +
    "; } \r\n" +
    ...
    textBackgroundColor +
    "; } \r\n" +
    "p.highlight::selection {background: " +
    complimentColor +
    ";\r\n" +
    "color: " +
    textHighlightColor +
    "; } \r\n" +
    "p.highlight::-moz-selection {background: " +
    complimentColor +
    ";\r\n" +
    "color: " +
    textHighlightColor +
  ...
  switch (viewMode)
  {
    case "CART":
      ...
      break;
    case "TRANSCRIPT":
      divContainerPartialTranscript.style.paddingLeft =
        leftRightMarginSize + "px";
      divContainerPartialTranscript.style.paddingRight =
        leftRightMarginSize + "px";
      divContainerPartialTranscript.style.paddingBottom =
        bottomMarginSize + "px";
      break;
  }
  ...
  if (searchText.length > 0)
  {
    ...
    for (var i = 0; i < bufferSize; ++i)
    {
      ...
      while (index != -1)
      {
        ...
        div.setAttribute(
          "onclick",
          "goToSearchResult(" + i + ", " + index + ", '" + searchText + "');"
        );
        ...
        var headerText =
          "Page " +
          caseViewNet.mainBuffer[i].page +
          ", Line " +
          caseViewNet.mainBuffer[i].line +
          " - " +
          count +
          " of ";
        ...
        {
          innerHTML =
            dataText.substring(0, index) +
            "<span class='spanBold spanHighlight'>" +
            dataText.substring(index, index + searchText.length) +
            "</span>" +
    ...
    switch (viewMode)
    {
      case "CART":
        if (documentHeightCalculated)
        {
          ...
          scrollTop +=
            (paragraphSizeArray[cartIndex] * offsetLine) / indexValues.length;
          ...
          innerHTML =
            paragraphData.substring(0, index) +
            "<span class='spanBold spanHighlight'>" +
            paragraphData.substring(index, index + searchText.length) +
            "</span>" +
      ...
      case "TRANSCRIPT":
        var scrollTop =
          lineHeight * indexLine - windowHeight / 2 + topMarginSize;
        ...
        } else
        {
          ...
          innerHTML =
            lineData.substring(0, index) +
            "<span class='spanBold spanHighlight'>" +
            lineData.substring(index, index + searchText.length) +
            "</span>" +
  ...
  switch (viewMode)
  {
    ...
    case "TRANSCRIPT":
      if (
        ...
        lineHighlightedIndex >= lineIndexTop &&
        lineHighlightedIndex <= lineIndexBottom
      )
      {
...
function OnLogMessage(log)
{
  ...
  if (log)
  {
    ...
    if (caseViewNet) clientName = caseViewNet.ClientName;
...
function showHideTimestamps()
{
  ...
  if (showTimestamps)
  {
    if (viewMode == "TRANSCRIPT") renderUpdateTranscript(lineIndexTop, true);
  } else
  {
    if (viewMode == "TRANSCRIPT") renderUpdateTranscript(lineIndexTop, true);
  }
...
function loadCookies()
{
  ...
  {
    setCookie(
      leftRightMarginTranscriptCookie,
      settingsTranscript.leftRightMarginSize
    );
  }
  ...
  {
    setCookie(
      bottomMarginTranscriptCookie,
      settingsTranscript.bottomMarginSize
    );
  }
  ...
  if (value != "")
  {
    ...
    if (fontBold)
    {
      //if the checkbox should be checked, let's do it
      labelFontBold.click();
    }
  } else
  {
...
function OnChatUserList()
{
  ...
  for (var i = 0; i < caseViewNet.ChatUsersList.length; ++i)
  {
    ...
    } else
    {
      ...
      user.setAttribute(
        "sessionCode",
        caseViewNet.ChatUsersList[i].sessionCode
      );
      ...
      divContactName.appendChild(
        document.createTextNode(caseViewNet.ChatUsersList[i].name)
      );
      ...
      //create conversation history container for this user
      var container = createChatConversationHistoryContainer(
        caseViewNet.ChatUsersList[i].name
      );
  ...
  for (var k = 0; k < keys.length; ++k)
  {
    ...
    if (chatUserMap.has(key))
    {
      ...
      {
        user.firstElementChild.setAttribute(
          "class",
          "divChatContactCircleOffline"
        );
      }
    }
  }
...
function createChatConversationHistoryContainer(userName)
{
  ...
  divConversationHistoryHeaderText.setAttribute(
    "class",
    "divConversationHistoryHeaderText"
  );
  divConversationHistoryHeaderText.appendChild(
...
function onChatUserChanged(event, divSelectedUser)
{
  ...
  if (chatUserMap.has(key) && chatConversationMap.has(key))
  {
    ...
    {
      divChatConversationHistory.removeChild(
        divChatConversationHistory.firstElementChild
      );
    } else
    {
    ...
    divCurrentUserConversationContainer.lastElementChild.scrollTop =
      divCurrentUserConversationContainer.lastElementChild.scrollHeight;

    //if there is a new message notification, remove it
    var user = chatUserMap.get(key);

    if (
      user.getElementsByClassName("divChatContactMessageNotification").length >
      0
    )
    {
      var node = user.getElementsByClassName(
        "divChatContactMessageNotification"
      )[0];
...
{
  console.log("In the send function"); // JK
  ...
  if (divCurrentSelectedUser != null && message != null && message.length > 0)
  {
    ...
    AddChatMessage(
      "Outgoing",
      divCurrentUserConversationContainer,
      name,
      message,
      userOnline
    );
...
function OnChatMessage(chatMessage)
{
  ...
  if (chatUserMap.has(key) && chatConversationMap.has(key))
  {
    ...
    var isThisChatDisplayed =
      chatFormShowed && divCurrentSelectedUser == chatUserMap.get(key);
    ...
    if (!isThisChatDisplayed)
    {
      ...
      if (
        user.getElementsByClassName("divChatContactMessageNotification")
          .length == 0
      )
      {
        var divCircle = document.createElement("div");
  ...
  if (divCurrentUserConversationContainer != null)
  {
    ...
    if (userOnline)
    {
      messageHeader.appendChild(
        document.createTextNode(name + " • " + messageTimestamp)
      );
    } else
    {
      if (caseViewNet.Connected)
      {
        messageHeader.appendChild(
          document.createTextNode("User Offline • Message not sent!")
        );
      } else
      {
        messageHeader.appendChild(
          document.createTextNode("You are Offline • Message not sent!")
        );
      }
    }
    ...
    if (direction == "Outgoing")
    {
      if (userOnline)
      {
        messageHeader.setAttribute(
          "class",
          "divConversationHistoryRowFooter divAlignRight"
        );
      } else
      {
        messageHeader.setAttribute(
          "class",
          "divConversationHistoryRowFooterOffline divAlignRight"
        );
      }
      divConversationHistoryMessage.setAttribute(
        "class",
        "divConversationHistoryMessage divFloatRight"
      );
    }
    if (direction == "Incoming")
    {
      messageHeader.setAttribute(
        "class",
        "divConversationHistoryRowFooter divAlignLeft"
      );
      divConversationHistoryMessage.setAttribute(
        "class",
        "divConversationHistoryMessage divFloatLeft"
      );
    }

    divConversationHistoryMessage.appendChild(
      document.createTextNode(chatMessage)
    );
    ...
    conversationContainer.lastChild.scrollTop =
      conversationContainer.lastChild.scrollHeight;
  }
}
...
function showHideChatForm()
{
  ...
  // JK - Set the effect type for JQuery toggle method
  var effect = "slide";
